    ...
    <div class="sidebar" id="sidebar">
      ...
      <nav class="nav-menu">
        ...
        <div class="nav-item has-submenu">
          ...
          <div class="submenu">
            <a href="#" class="submenu-link active">New Health Record</a>
      ...
      <div class="col-md-9">
        <div class="content-card">
          ...
          <form id="healthRecordForm">
            ...
            <div class="form-row row">
              <div class="col-md-6">
                <label for="search-species" class="form-label"
                  >Species</label
                >
                <input class="form-control" id="search-species" disabled />
              </div>
              <div class="col-md-6">
                <label for="search-breed" class="form-label"
                  >Breed</label
                >
