          ...
          .map(
            (item, index) => `
                <tr>
                    ...
                    <td>
                        <button class="action-btn btn-edit" onclick="editLivestock(${index})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="action-btn btn-delete" onclick="deleteLivestock(${index})">
      ...
      document
        ...
        .addEventListener("submit", function (e) {
          ...
          bootstrap.Modal.getInstance(
            document.getElementById("addLivestockModal")
          ).hide();
          this.reset();
