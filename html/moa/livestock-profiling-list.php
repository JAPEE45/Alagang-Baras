      ...
      <main class="main-content">
        <div class="header d-flex align-items-center justify-content-between">
          <h2 class="page-title fade-in">
            <i class="fas fa-clipboard-list me-3"></i>Livestock List
          </h2>
          <a href="./livestock-profiling.php" class="btn btn-add-record">
          ...
          <div class="table-responsive">
            <table class="table mb-0" id="healthRecordsTable">
             ...
             echo "<tr>  
                ...
                <td>".$r['sex']."</td>
                <td>
                    <a class='btn btn-sm btn-outline-primary me-1' href='./livestock-profiling-list.php'>
